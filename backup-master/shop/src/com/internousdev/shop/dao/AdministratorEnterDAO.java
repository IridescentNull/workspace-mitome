	...
	public AdministratorEnterDTO getDto(String administratorId, String administratorPassword){
		...
		try{
			...
			if(resultSet.next()){
				...
				dto.setAdministratorIdShadow(resultSet.getString("administrators_login_id"));
				dto.setAdministratorPassword(resultSet.getString("administrators_login_password"));
				dto.setAdministratorUserName(resultSet.getString("administrators_user_name"));

				if(!(resultSet.getString("administrators_login_id").equals(null))){
