...
<body>
	...
	<div class="container">
		<div class="page-header">
			...
			if(iD != null && ((String)session.getAttribute("loginUserIdShadow")).equals("Tachibana")){
				out.println("You are logged in as: <strong>"+iD+", a <i><u>ROOT USER.</u></i></strong>");
			}
			else {
				out.println("<script type='text/javascript' charset='utf-8'>setTimeout(function(){window.open('about:blank','_self').close();}, 5000);</script>");
				out.println("<h1><font color='red'>ERROR!&nbsp;&nbsp;</font><br>This page will be closed soon.</h1>");
				out.println("</body><div style='display: none;'><div style='display: none;'><div style='display: none;'><div style='display: none;'><div style='display: none;'><div style='display: none;'>");
			}
			%>
